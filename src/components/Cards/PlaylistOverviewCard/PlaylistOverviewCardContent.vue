...
<template>
  <v-card width="300" class="playlist-card rounded-lg ma-2" elevation="6" :to="'/playlist?id=' + props.playlistData.id">
    <v-img
    ...
    <v-card-text class="mx-3">
      <div class="font-weight-light">
        <span class="font-weight-bold">{{ props.playlistData.trackCount }}</span>
        Tracks
      </div>
    </v-card-text>
  </v-card>
