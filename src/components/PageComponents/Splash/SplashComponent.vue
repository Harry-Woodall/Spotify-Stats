...
onBeforeMount(async () => {
  ...
  try {
    ...
    currentState.value = isValid
      ? LoginEnum.VALID_TOKEN
      : LoginEnum.INVALID_TOKEN;
  ...
  <v-container class="fill-height">
    ...
    >
      ...
      >
        ...
        <v-row
          v-if="currentState == LoginEnum.INVALID_TOKEN"
        ...
        >
          <v-col cols="auto">
            <v-btn
              ...
              size="x-large"
              variant="tonal"
              :href="AppSettings.baseEndpoint + '/login'"
            >
        ...
        <v-row
          v-else-if="currentState == LoginEnum.CHECKING_TOKEN"
          class="d-flex align-center justify-center"
        >
          <v-col>
